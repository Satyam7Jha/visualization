import { AxisLabelWithLoadingTime } from "../custom-components/axis-label-with-loading-time";
...
const OPTIONS = {
    ...
    "xAxis": [
      {
        CustomComponent:AxisLabelWithLoadingTime,
        "labels": {
          "y": 20,
          "useHTML": true,
          formatter: function () {
  ...
  export const useColumnChartWithAxisLoader= () => {
    return OPTIONS
}